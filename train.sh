...
# Debug toggles (enable one at a time for binary search)
export DEBUG_FREEZE_ACTION_MEMORY_ALL=1
# export DEBUG_FREEZE_ACTION_MEMORY_READOUT=1
# export DEBUG_FORCE_MEMORY_TO_LOSS=1
# export DEBUG_FREEZE_ACTION_HEAD_ALL=1
# export DEBUG_FREEZE_ACTION_DECODER=1
